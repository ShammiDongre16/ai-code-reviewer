...
def main():
    ...
    headers = {
        ...
        "Accept": "application/vnd.github.v3.diff" # This header fetches the raw code changes
    }
    ...
    try:
        # Using gemini-2.5-flash for fast and cost-free execution
    ...
    # Format markdown body beautifully for GitHub
    comment_body = {
